...
!function (e) {
    ...
    t.m = e, t.c = a, t.d = function (e, a, n) {
        ...
        if (t.r(n), Object.defineProperty(n, "default", {
            enumerable: !0,
            value: e
        }), 2 & a && "string" != typeof e) for (var o in e) t.d(n, o, function (a) {
            return e[a]
        }.bind(null, o));
        return n
    }, t.n = function (e) {
    ...
    var r = function () {
        ...
        return a = e, n = [{
            key: "run", value: function (e) {
                var a = this, t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = {
                ...
                if (e instanceof Array) for (var o in e) n[e[o]] && n[e[o]](t); else n[e] && n[e](t)
            }
        }, {
            ...
            key: "coreScrollTo", value: function () {
                jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on("click.cb.helpers.core", function (e) {
                    e.stopPropagation();
                    var a = jQuery("#page-header"), t = jQuery(e.currentTarget), n = t.data("target") || t.attr("href"),
                        o = t.data("speed") || 1e3,
            ...
            key: "coreAppear", value: function () {
                jQuery('[data-toggle="appear"]:not(.js-appear-enabled)').each(function (e, a) {
                    var t = o.getWidth(), n = jQuery(a), l = n.data("class") || "animated fadeIn",
                        r = n.data("offset") || 0, i = t < 992 ? 0 : n.data("timeout") ? n.data("timeout") : 0;
            ...
            key: "coreAppearCountTo", value: function () {
                jQuery('[data-toggle="countTo"]:not(.js-count-to-enabled)').each(function (e, a) {
                    var t = jQuery(a), n = t.data("after"), o = t.data("before");
                ...
                jQuery(".js-table-checkable:not(.js-table-checkable-enabled)").each(function (a, t) {
                    ...
                    n.addClass("js-table-checkable-enabled"), jQuery("thead input:checkbox", n).on("click.cb.helpers", function (a) {
                        ...
                        if (!("checkbox" === a.target.type || "button" === a.target.type || "a" === a.target.tagName.toLowerCase() || jQuery(a.target).parent("a").length || jQuery(a.target).parent("button").length || jQuery(a.target).parent(".custom-control").length || jQuery(a.target).parent("label").length)) {
                            var t = jQuery("input:checkbox", a.currentTarget), o = t.prop("checked");
            ...
            key: "contentFilter", value: function () {
                jQuery(".js-filter:not(.js-filter-enabled)").each(function (e, a) {
                    var t, n = jQuery(a), l = jQuery(".nav-pills", n), r = jQuery("a[data-category-link]", n),
                        i = jQuery("[data-category]", n), s = n.data("speed") || 200;
                    ...
                    n.data("numbers") && r.each(function (e, a) {
                        var t = jQuery(a), n = t.data("category-link");
            ...
            key: "draggableItems", value: function () {
    ...
    var s = function () {
        ...
        return a = e, (t = [{
            ...
            key: "_uiHandleScroll", value: function () {
            ...
            key: "_uiHandleMain", value: function () {
                var e, a = this;
                jQuery(window).off("resize.cb.main orientationchange.cb.main"), a._lMain.length && jQuery(window).on("resize.cb.main orientationchange.cb.main", function (t) {
                    clearTimeout(e), e = setTimeout(function (e) {
                        var t = jQuery(window).height(), n = a._lHeader.outerHeight() || 0,
            ...
            key: "_uiHandleHeader", value: function () {
                var e = this;
            ...
            key: "_uiHandleNav", value: function () {
                ...
                e._lPage.off("click.cb.menu"), e._lPage.on("click.cb.menu", '[data-toggle="nav-submenu"]', function (a) {
                    var t = jQuery(a.currentTarget), n = t.parent("li");
            ...
            key: "_uiHandleForms", value: function () {
                jQuery(".form-material.floating > .form-control").each(function (e, a) {
                    var t = jQuery(a), n = t.parent(".form-material");
            ...
            key: "_uiHandleTheme", value: function () {
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').parent("li").addClass("active"), this._lPage.off("click.cb.themes"), this._lPage.on("click.cb.themes", '[data-toggle="theme"]', function (t) {
                    t.preventDefault();
                    var n = jQuery(t.currentTarget), l = n.data("theme");
            ...
            key: "_uiApiBlocks", value: function () {
                var e, a, t, n = this, o = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                    l = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "init", r = this,
                    i = "si si-size-fullscreen", s = {
                        init: function () {
